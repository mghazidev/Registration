...
export default {
  ...
  plugins: [
    require("tailwindcss-plugin")(({ addComponents, theme }: any) => {
      addComponents({
        ".h1": {
        ...
        ".body-1-medium": {
          ...
          letterSpacing: theme("fontSize.body-1-medium")[1].letterSpacing,
          fontWeight: theme("fontWeight.medium"),
        },
        ".body-2-medium": {
          fontFamily: theme("fontFamily.fustat"),
          fontSize: theme("fontSize.body-2-medium")[0],
          lineHeight: theme("fontSize.body-2-medium")[1].lineHeight,
          letterSpacing: theme("fontSize.body-2-medium")[1].letterSpacing,
          fontWeight: theme("fontWeight.medium"),
        },
        ".body-3-medium": {
          fontFamily: theme("fontFamily.fustat"),
          fontSize: theme("fontSize.body-3-medium")[0],
          lineHeight: theme("fontSize.body-3-medium")[1].lineHeight,
          letterSpacing: theme("fontSize.body-3-medium")[1].letterSpacing,
          fontWeight: theme("fontWeight.medium"),
        },
        ".body-1-regular": {
          fontFamily: theme("fontFamily.fustat"),
          fontSize: theme("fontSize.body-1-regular")[0],
          lineHeight: theme("fontSize.body-1-regular")[1].lineHeight,
          letterSpacing: theme("fontSize.body-1-regular")[1].letterSpacing,
          fontWeight: theme("fontWeight.medium"),
        },
        ".body-2-regular": {
          fontFamily: theme("fontFamily.fustat"),
          fontSize: theme("fontSize.body-2-regular")[0],
          lineHeight: theme("fontSize.body-2-regular")[1].lineHeight,
          letterSpacing: theme("fontSize.body-2-regular")[1].letterSpacing,
          fontWeight: theme("fontWeight.medium"),
        },
        ".body-3-regular": {
          fontFamily: theme("fontFamily.fustat"),
          fontSize: theme("fontSize.body-3-regular")[0],
          lineHeight: theme("fontSize.body-3-regular")[1].lineHeight,
          letterSpacing: theme("fontSize.body-3-regular")[1].letterSpacing,
          fontWeight: theme("fontWeight.medium"),
        },
        ".label-1-medium": {
          fontFamily: theme("fontFamily.fustat"),
          fontSize: theme("fontSize.label-1-medium")[0],
          lineHeight: theme("fontSize.label-1-medium")[1].lineHeight,
          letterSpacing: theme("fontSize.label-1-medium")[1].letterSpacing,
          fontWeight: theme("fontWeight.medium"),
        },
        ".label-2-medium": {
          fontFamily: theme("fontFamily.fustat"),
          fontSize: theme("fontSize.label-2-medium")[0],
          lineHeight: theme("fontSize.label-2-medium")[1].lineHeight,
          letterSpacing: theme("fontSize.label-2-medium")[1].letterSpacing,
          fontWeight: theme("fontWeight.medium"),
        },
        ".link-1-regular": {
          fontFamily: theme("fontFamily.fustat"),
          fontSize: theme("fontSize.link-1-regular")[0],
          lineHeight: theme("fontSize.link-1-regular")[1].lineHeight,
          letterSpacing: theme("fontSize.link-1-regular")[1].letterSpacing,
          fontWeight: theme("fontWeight.medium"),
